...
document.getElementById('btn-quick-bm').addEventListener('click', async () => {
  ...
  S.bookmarks.push({ id: 'bm_' + Date.now(), name: title.slice(0, 20), url });
  renderBM();
...
function showWsLoginModal(wsIdx) {
  ...
  modal.innerHTML = `
    <svg width="40" height="40" viewBox="0 0 48 48"><path d="M44.5 20H24v8.5h11.8C34.7 33.9 30.1 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 4.1 29.6 2 24 2 11.8 2 2 11.8 2 24s9.8 22 22 22c11 0 21-8 21-22 0-1.3-.2-2.7-.5-4z" fill="#FFC107"/><path d="M6.3 14.7l7.4 5.4C15.5 16 19.5 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 4.1 29.6 2 24 2 16.3 2 9.7 7.4 6.3 14.7z" fill="#FF3D00"/><path d="M24 46c5.5 0 10.5-1.9 14.3-5.1l-6.6-5.6C29.7 36.8 27 37.5 24 37.5c-6 0-10.7-4-12.3-9.5L4.2 33.6C7.6 40.9 15.2 46 24 46z" fill="#4CAF50"/><path d="M44.5 20H24v8.5h11.8c-.7 2.8-2.4 5.1-4.7 6.7l6.6 5.6C42 37.5 45 31.3 45 24c0-1.3-.2-2.7-.5-4z" fill="#1976D2"/></svg>
    ...
    <button id="ws-login-go-btn" style="display:flex;align-items:center;gap:8px;padding:10px 18px;border-radius:11px;border:1px solid var(--card-border);background:var(--card);cursor:pointer;font-size:13px;font-weight:500;color:var(--text);font-family:inherit;width:100%;justify-content:center;">
      <svg width="16" height="16" viewBox="0 0 48 48"><path d="M44.5 20H24v8.5h11.8C34.7 33.9 30.1 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 4.1 29.6 2 24 2 11.8 2 2 11.8 2 24s9.8 22 22 22c11 0 21-8 21-22 0-1.3-.2-2.7-.5-4z" fill="#FFC107"/><path d="M6.3 14.7l7.4 5.4C15.5 16 19.5 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 4.1 29.6 2 24 2 16.3 2 9.7 7.4 6.3 14.7z" fill="#FF3D00"/><path d="M24 46c5.5 0 10.5-1.9 14.3-5.1l-6.6-5.6C29.7 36.8 27 37.5 24 37.5c-6 0-10.7-4-12.3-9.5L4.2 33.6C7.6 40.9 15.2 46 24 46z" fill="#4CAF50"/><path d="M44.5 20H24v8.5h11.8c-.7 2.8-2.4 5.1-4.7 6.7l6.6 5.6C42 37.5 45 31.3 45 24c0-1.3-.2-2.7-.5-4z" fill="#1976D2"/></svg>
      Googleでログイン
    </button>
  `;
